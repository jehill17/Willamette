...
x = (CGR_2005_daily[1:364].astype('float'))
y = hydropower_all[1:364,3]
...
x = (DEX_2005_daily[1:364].astype('float'))
y = hydropower_all[1:364,2]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
...
x = (HCR_2005_daily[1:364].astype('float'))
y = hydropower_all[1:364,0]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
...
#HCR OUTFLOWS
x = (HCR.dataOUT[0:364,1].astype('float'))
y = outflows_all[0:364,0]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
HCR.R2 = r_val**2
print(HCR.R2)
...
x = (LOP_2005_daily[1:364].astype('float'))
y = hydropower_all[1:364,1]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
...
#COT
x = (COT.dataOUT[0:364,1].astype('float'))
y = outflows_all[0:364,5]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
COT.R2 = r_val**2
print(COT.R2)
...
#DOR
x = (DOR.dataOUT[0:364,1].astype('float'))
y = outflows_all[0:364,4]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
DOR.R2 = r_val**2
print(DOR.R2)
...
#FAL
x = (FAL.dataOUT[0:364,1].astype('float'))
y = outflows_all[0:364,3]
slope,intercept,r_val,p_val,std_err = stats.linregress(x,y)
FAL.R2 = r_val**2
print(FAL.R2)
